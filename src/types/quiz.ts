...
export const QUIZ_QUESTIONS: Question[] = [
  ...
  },
  {
    id: 12,
    key: "email_opt_in",
    question: "Quer receber seu plano personalizado agora?",
    options: [
      { value: "yes", label: "Sim — quero ver meu plano agora" },
      { value: "no", label: "Não por agora — só quero ver as dicas grátis" },
    ],
  },
];
